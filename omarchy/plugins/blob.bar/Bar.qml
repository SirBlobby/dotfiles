...
Item {
  ...
  component ModuleSlot: Item {
    ...
    readonly property bool anchored: region === "center" && moduleName === root.centerAnchor
    ...
    MouseArea {
      ...
      property real pressedX: 0
      property real pressedY: 0
      readonly property bool canReorder: !slot.anchored && root.shell && typeof root.shell.mutateShellConfig === "function"
      readonly property real dragThreshold: Style.space(4)
